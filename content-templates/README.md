...
Ces fichiers servent de modèles pour créer une nouvelle formation sans toucher au code.
...
- **formation-complete.template.json** : un seul JSON (course + modules + missions) pour génération par outil (ex. ChatGPT). Une fois rempli, utiliser le script d’import : `node scripts/import-formation.js chemin/vers/formation-complete.json`.
